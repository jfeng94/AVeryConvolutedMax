...
float get_intersection(Point * origin, Point * direction, Point * r, float e, float n, float NSCALE, int ITERATIONS)
{
    float t_old, t_new;
    bool done;
    float g, g_prime;
    ...
    // Get initial guess
    t_old = get_initial_guess(origin, direction);
    t_new = t_old;
    ...
    while(iterations < ITERATIONS)
    {
        ...
        t_old = t_new;
        g = superquadric(origin, direction, t_old, e, n);
        g_prime = superquadric_prime(origin, direction, t_old, e, n);
